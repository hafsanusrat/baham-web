...
def view_vehicles(request):
    ...
    vehicles = VehicleModel.objects.all().filter(voided=False).order_by('vendor')
    context = {
        'navbar': 'vehicles',
        'vehicles': vehicles
    }
